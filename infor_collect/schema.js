        ...
        fields: [
          {
            ...
            rows: 4,
            placeholder: "名称（中英）\n简介\n项目名：一句话",
            example: "触觉交互研究 / Tactile Interaction\n触觉舒适性、非遗共创与多模态参与式工具。\n具身智能下产品触觉舒适性评价与设计研究：构建触觉舒适性理论体系与实体界面设计策略。",
          },
          {
            key: "theme2",
            ...
            rows: 4,
            placeholder: "名称（中英）\n简介\n项目名：一句话",
            example: "用户体验中的人工智能 / AI in User Experience\n系统级 AI 洞察、自动化测评与智能感评价。\n自动化用户体验研究工具：用多模态大模型完成界面理解、角色模拟与自动测评。",
          },
          {
            key: "theme3",
            ...
            rows: 4,
            placeholder: "名称（中英）\n简介\n项目名：一句话",
            example: "人因工程研究 / Human Factors Engineering\n人因全景、手势规范、动效阈值与智能终端场景。\n构建人因研究全景框架：整合智能手机软硬件人因研究，形成全景图与可视化平台。",
          },
          {
            key: "theme4",
            ...
            rows: 4,
            placeholder: "名称（中英）\n简介\n项目名：一句话",
            example: "智能家电与生活场景研究 / Smart Appliances and Living Scenes\n厨电体验、生活场景、数据平台与国际协同。\n华帝硬件UX体验创新：探索未来厨房的厨电硬件交互概念与人机技术路线。",
          },
        ],
      },
      {
