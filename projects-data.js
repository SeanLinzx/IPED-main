...
const HOME_THEMES = [
  {
    ...
    zh: { title: "触觉交互", intro: "触觉舒适性、非遗共创与多模态参与式工具。" },
    en: { title: "Haptic Interaction", intro: "Tactile comfort, ICH co-creation and multimodal tools." },
  },
  {
    id: "humanfactors",
    cover: "./assets/home/focus-02.png",
    projects: ["vivo-hf", "yuelu", "gesture", "motion"],
    zh: { title: "人智协同", intro: "人因全景、手势规范、动效阈值与智能终端场景。" },
    en: { title: "Human-AI Co-Design", intro: "HF panorama, gesture guidelines, motion thresholds and intelligent terminals." },
  },
  {
    id: "aiux",
    cover: "./assets/home/focus-03.png",
    projects: ["ai-insight", "auto-ux", "usability"],
    zh: { title: "用户体验与人因", intro: "系统级 AI 洞察、自动化测评与智能感评价。" },
    en: { title: "UX and Human Factors", intro: "System-level AI insight, automated evaluation and intelligence perception." },
  },
  {
    id: "scene",
    cover: "./assets/home/focus-04.png",
    projects: ["vatti-oasis", "vatti-hw", "vatti-basket", "platform", "engine"],
    zh: { title: "生活方式与场景创新", intro: "厨电体验、生活场景、数据平台与国际协同。" },
    en: { title: "Lifestyle & Scenes Innovation", intro: "Kitchen experience, living scenes, data platforms and teaching." },
  },
];
